---
title: Контрольный список для версии 1802
titleSuffix: Configuration Manager
description: Сведения о действиях, которые необходимо выполнить перед обновлением до Configuration Manager версии 1802.
ms.date: 06/08/2018
...
ms.locfileid: "81707682"
---
# <a name="checklist-for-installing-update-1802-for-configuration-manager"></a>Контрольный список для установки обновления 1802 для Configuration Manager

*Область применения: Configuration Manager (Current Branch)*

При использовании текущего ответвления Configuration Manager можно установить обновление в консоль для версии 1802 для обновления иерархии по сравнению с предыдущей версией. <!-- baseline only statement: -->(Так как версия 1802 также доступна как [базовый носитель](updates.md#bkmk_Baselines), вы можете использовать установочный носитель для установки первого сайта новой иерархии.)
...
-   Если обновление имеет состояние **Доступно**, оно готово к установке. Прежде чем установить версию 1802, просмотрите [сведения об установке обновления 1802](#about-installing-update-1802) и [контрольный список](#checklist) настроек, которые нужно выполнить перед началом обновления.
...
## <a name="about-installing-update-1802"></a>Информация об установке обновления 1802
...
<!--SCCMdocs#587-->   
Если вы расширяете возможности Configuration Manager с помощью других продуктов корпорации Майкрософт или ее партнеров, убедитесь в том, что они поддерживают версию 1802. Эту информацию можно получить у поставщика продукта. Например, см. [заметки о выпуске](../../../mdt/release-notes.md) Microsoft Deployment Toolkit.
