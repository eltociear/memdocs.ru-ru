...
2.  Выберите сайт. На ленте нажмите кнопку **Настройка компонентов сайта** и выберите пункт **Распространение программного обеспечения**.  
