...
- Вы можете [настроить клиенты на поиск точек управления в DNS](../../clients/deploy/configure-client-computers-to-find-management-points-by-using-dns-publishing.md).  
