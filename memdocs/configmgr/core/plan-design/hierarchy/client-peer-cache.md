...
Клиент Configuration Manager использует одноранговый кэша для предоставления каждого типа содержимого в кэше другим клиентам. Это содержимое включает в себя файлы Приложений Microsoft 365 для предприятия и файлы экспресс-установки.<!--SMS.500850-->  
