...
|Сертификат службы для подключения клиентов к облачным точкам распространения|Инструкции по настройке и установке этого сертификата см. в подразделе [Развертывание сертификата службы для облачных точек распространения](#BKMK_clouddp2008_cm2012) этого раздела.<br /><br /> **Внимание!** Этот сертификат используется вместе с сертификатом управления Windows Azure. Дополнительные сведения о сертификате управления см. в разделах [Создание сертификата управления](https://docs.microsoft.com/azure/cloud-services/cloud-services-certs-create#create-a-new-self-signed-certificate) и [Добавление сертификата управления в подписку Microsoft Azure](https://docs.microsoft.com/azure/cloud-services/cloud-services-configure-ssl-certificate-portal#step-3-upload-a-certificate).|  
