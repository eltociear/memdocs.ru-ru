---
title: Выпуск Technical Preview версии 2001.2
titleSuffix: Configuration Manager
description: Сведения о новых функциях, доступных в ветви технической версии Configuration Manager 2001.2.
ms.date: 02/03/2020
...
ms.locfileid: "81691992"
---
# <a name="features-in-configuration-manager-technical-preview-version-20012"></a>Функции, доступные в Configuration Manager Technical Preview версии 2001.2

*Область применения: Configuration Manager (ветвь Technical Preview)*

Эта статья содержит сведения о функциях, доступных в версии 2001.2 Technical Preview для Configuration Manager. Установите эту версию, чтобы обновить и добавить функции в сайт версии Technical Preview.
...
## <a name="general-known-issues"></a>Известные общие проблемы
