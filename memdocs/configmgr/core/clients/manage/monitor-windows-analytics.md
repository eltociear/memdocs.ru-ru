---
title: Мониторинг клиентов с помощью Windows Analytics
titleSuffix: Configuration Manager
description: Windows Analytics — это набор решений, которые предоставляют ценные сведения о текущем состоянии среды.
ms.date: 01/31/2020
...
Если сайт Configuration Manager был подключен к решению "Проверка готовности к обновлению", необходимо удалить его и заново настроить клиенты. Дополнительные сведения см. в разделе [Удаление подключения к решению "Проверка готовности к обновлению"](upgrade-readiness.md#bkmk_remove).
