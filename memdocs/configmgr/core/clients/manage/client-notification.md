...
- **Сбор журналов клиента** (начиная с версии 2002): Сообщение с уведомлением клиента отправляется выбранным клиентам для сбора журналов CCM. Журналы возвращаются с помощью сбора файлов инвентаризации программного обеспечения. <!--4226618-->
