---
title: Безопасность и конфиденциальность удаленного управления
titleSuffix: Configuration Manager
description: Сведения о безопасности и конфиденциальности удаленного управления в Configuration Manager.
ms.date: 04/23/2017
...
ms.locfileid: "81696402"
---
# <a name="security-and-privacy-for-remote-control-in-configuration-manager"></a>Безопасность и конфиденциальность удаленного управления в Configuration Manager

*Область применения: Configuration Manager (Current Branch)*

В этой статье содержатся сведения о безопасности и конфиденциальности функции удаленного управления в Configuration Manager.  

##  <a name="security-best-practices-for-remote-control"></a><a name="BKMK_Security_HardwareInventory"></a> Рекомендации по обеспечению безопасности для удаленного управления  
...
|Не разрешайте пользователям настраивать параметры удаленного управления в центре программного обеспечения.|Не включайте параметр клиента **В центре программного обеспечения пользователи могут изменять политику или параметры уведомления**, чтобы предотвратить угрозу слежения за пользователями. Если один из пользователей изменит его, это позволит следить за другим пользователем этого же компьютера удаленно. <br /><br />**Это параметр используется для компьютера, а не для пользователя, выполнившего вход в систему**.|  
