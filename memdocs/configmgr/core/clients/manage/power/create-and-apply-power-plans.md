...
8. В диалоговом окне <em>Свойства\></em> **<имя схемы управления питанием** настройте следующие параметры.  
   ...
   -   **Specify the properties for this power plan**  (Укажите свойства для этой схемы управления питанием). Настройте свойства схемы. Для отключения свойства снимите флажок. Дополнительные сведения о доступных параметрах см. в разделе [Available power management plan settings](#BKMK_Plans) этой статьи.  
...
9. Нажмите кнопку **ОК**, чтобы закрыть диалоговое окно <em>Свойства\></em> **<имя схемы управления питанием**.  

10. Нажмите кнопку **ОК**, чтобы закрыть окно <em>Параметры\></em> **<имя коллекции** и применить схему управления питанием.  
...
|**Действие кнопки питания**|Указывает действие при нажатии кнопки питания компьютера. Возможные значения — **Ничего не делать**, **Спящий режим**, **Режим гибернации** и **Завершение работы**.|  
|**Кнопка питания меню "Пуск"**|Указывает действие, выполняемое при нажатии кнопки питания в меню **Пуск** . Возможные значения — **Спящий режим**, **Режим гибернации** и **Завершение работы**.|  
|**Действие кнопки спящего режима**|Указывает действие, выполняемое при нажатии **Спящий режим** . Возможные значения — **Ничего не делать**, **Спящий режим**, **Режим гибернации** и **Завершение работы**.|  
...
|**Действие низкого заряда батарей**|Указывает действие, выполняемое при достижении уровня заряда батареи указанного низкого значения. Возможные значения — **Ничего не делать**, **Спящий режим**, **Режим гибернации** и **Завершение работы**.|  
|**Действие почти полной разрядке батарей**|Указывает действие, выполняемое при достижении уровня заряда батареи указанного критически низкого значения. При питании **От батареи** возможные значения — **Спящий режим**, **Гибернация** и **Завершение работы**. При питании от сети (**Подключено**) возможные значения — **Действий не требуется**, **Спящий режим**, **Гибернация** и **Завершение работы**.|  
