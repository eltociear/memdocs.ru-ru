...
|**Действие кнопки спящего режима**|Указывает действие, выполняемое при нажатии кнопки **Спящий режим**. Возможные значения — **Ничего не делать**, **Спящий режим**, **Режим гибернации** и **Завершение работы**.|  
