...
###  <a name="computer-details-report"></a><a name="BKMK_Computer_Details"></a> Отчет "Сведения о компьютере"  
...
###  <a name="energy-consumption-report"></a><a name="BKMK_Consumption"></a> Отчет "Энергопотребление"  
