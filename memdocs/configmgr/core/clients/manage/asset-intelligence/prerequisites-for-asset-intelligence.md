---
title: Предварительные требования для аналитики активов
titleSuffix: Configuration Manager
description: Узнайте о предварительных требованиях для аналитики активов в Configuration Manager.
ms.date: 02/22/2017
...
ms.locfileid: "82906585"
---
# <a name="prerequisites-for-asset-intelligence-in-configuration-manager"></a>Необходимые условия для аналитики активов в Configuration Manager

*Область применения: Configuration Manager (Current Branch)*

Функция аналитики активов в Configuration Manager имеет внешние зависимости и зависимости в пределах продукта.  
...
|Точка служб отчетов|Для отображения отчетов по обновлениям программного обеспечения необходимо предварительно установить роль системы сайта точки служб отчетов. Дополнительные сведения о создании точки служб отчетов см. в разделе [Настройка отчетов](../../../servers/manage/configuring-reporting.md).|  
