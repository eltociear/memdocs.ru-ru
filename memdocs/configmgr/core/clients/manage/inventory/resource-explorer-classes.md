---
title: Классы инвентаризации по умолчанию в обозревателе ресурсов
titleSuffix: Configuration Manager
description: Показывает классы, отображаемые в обозревателе ресурсов
ms.date: 11/12/2019
...
ms.locfileid: "81690182"
---
# <a name="resource-explorer-default-inventory-classes"></a>Классы инвентаризации по умолчанию в обозревателе ресурсов

*Область применения: Configuration Manager (Current Branch)*

Эта статья описывает классы инвентаризации по умолчанию в обозреватель ресурсов.

Ниже перечислены классы инвентаризации по умолчанию:

## <a name="1394-controller"></a>1394 Controller (Контроллер 1394)
...
## <a name="account-sid"></a>Account SID (Идентификатор безопасности учетной записи)
...
## <a name="activesync-service"></a>ActiveSync Service (Служба ActiveSync)

Пространство имен: root\SmsDm
...
## <a name="amt-agent"></a>AMT Agent (Агент AMT)

Пространство имен: root\cimv2\sms
...
## <a name="appv-client-application"></a>AppV Client Application (Клиентское приложение AppV)

Пространство имен: root\AppV
...
## <a name="appv-client-package"></a>AppV Client Package (Пакет клиента AppV)
...
## <a name="autostart-software"></a>AutoStart Software (Программное обеспечение с автозапуском)
...
Пространство имен: root\cimv2\security\MicrosoftVolumeEncryption
...
## <a name="bitlocker-encryption-details"></a>BitLocker Encryption Details (Сведения о шифровании BitLocker)
...
## <a name="bitlocker-policy"></a>BitLocker Policy
...
## <a name="boot-configuration"></a>Boot Configuration (Конфигурация загрузки)
...
## <a name="browser-helper-object"></a>Browser Helper Object (Вспомогательный элемент браузера)
...
Пространство имен: root\ccm\cimodels
...
## <a name="cd-rom"></a>CD-ROM (Устройство чтения компакт-дисков)
...
## <a name="client-events"></a>Client Events (События клиента)

Пространство имен: root\ccm\invagt
...
## <a name="computer-system"></a>Компьютерная система
...
## <a name="computer-system-ex"></a>Computer System Ex (Расширенная компьютерная система)
...
## <a name="computer-system-product"></a>Продукт компьютерной системы
...
## <a name="sms-advanced-client-ports"></a>SMS Advanced Client Ports (Порты расширенного клиента SMS)
...
## <a name="sms-advanced-client-ssl-configurations"></a>SMS Advanced Client SSL Configurations (Конфигурации SSL расширенного клиента SMS)
...
## <a name="sms-advanced-client-state"></a>SMS Advanced Client State (Состояние расширенного клиента SMS)

Пространство имен: root\ccm
...
## <a name="connected-device"></a>Connected Device (Подключенное устройство)
...
## <a name="desktop-monitor"></a>Настольный монитор
...
## <a name="device-info"></a>Device Info (Сведения об устройстве)

Пространство имен: Зарезервировано
...
## <a name="dma-channel"></a>DMA Channel (Канал DMA)
...
## <a name="driver---vxd"></a>Driver - VxD (Драйвер — VxD)
...
## <a name="embedded-device-information"></a>Embedded Device Information (Сведения об устройстве Embedded)
...
## <a name="firmware"></a>Firmware (Встроенное ПО)
...
## <a name="usm-folder-redirection-health"></a>USM Folder Redirection Health (Работоспособность перенаправления папок USM)
...
## <a name="ide-controller"></a>IDE Controller (Контроллер IDE)
...
## <a name="add-remove-programs-64"></a>Add Remove Programs (64) (Установка и удаление программ (64))
...
## <a name="add-remove-programs"></a>Add Remove Programs (Установка и удаление программ)
...
## <a name="installed-executable"></a>Installed Executable (Установленный исполняемый файл)
...
## <a name="installed-software"></a>Установленное ПО
...
## <a name="irq-table"></a>IRQ Table (Таблица запросов прерываний)
...
## <a name="load-order-group"></a>Load Order Group (Группа порядка загрузки)
...
## <a name="logical-disk"></a>Logical Disk (Логический диск)
...
## <a name="device-bluetooth"></a>Device Bluetooth (Адаптер Bluetooth устройства)
...
## <a name="device-camera"></a>Device Camera (Камера устройства)
...
## <a name="device-certificates"></a>Device Certificates (Сертификаты устройства)
...
## <a name="device-client"></a>Device Client (Клиент устройства)
...
## <a name="device-client-agent-version"></a>Device Client Agent version (Версия агента клиента устройства)
...
## <a name="device-computer-system"></a>Device Computer System (Компьютерная система устройства)
...
## <a name="device-display"></a>Device Display (Экран устройства)
...
## <a name="device-email"></a>Device Email (Электронная почта устройства)
...
## <a name="device-encryption"></a>Шифрование устройства
...
## <a name="device-exchange"></a>Device Exchange (Exchange для устройств)
...
## <a name="device-installed-applications"></a>Device Installed Applications (Приложения, установленные на устройстве)
...
## <a name="device-irda"></a>Device IrDA (IRDA устройства)
...
## <a name="mobile-device-location"></a>Mobile Device Location (Расположение мобильного устройства)
...
## <a name="device-memory"></a>Device Memory (Память устройства)
...
## <a name="device-os-information"></a>Device OS Information (Сведения об ОС устройства)
...
## <a name="device-password"></a>Device Password (Пароль устройства)
...
## <a name="device-policy"></a>Device Policy (Политика устройств)
...
## <a name="device-power"></a>Device Power (Питание устройства)
...
## <a name="mobile-device-security-status"></a>Mobile Device Security Status (Состояние безопасности мобильного устройства)
...
## <a name="device-windows-security-policy"></a>Device Windows Security Policy (Политика безопасности Windows для устройств)
...
## <a name="device-wlan"></a>Device WLAN (Беспроводная сеть устройства)
...
## <a name="motherboard"></a>Motherboard (Системная плата)
...
## <a name="nap-client"></a>NAP Client (Клиент NAP)

Пространство имен: root\Nap
...
## <a name="nap-system-health-agent"></a>NAP System Health Agent (Агент работоспособности системы защиты доступа к сети)
...
## <a name="network-adapter"></a>Сетевой адаптер
...
## <a name="network-adapter-configuration"></a>Network Adapter Configuration (Конфигурация сетевого адаптера)
...
## <a name="network-client"></a>Network Client (Сетевой клиент)
...
## <a name="network-login-profile"></a>Network Login Profile (Профиль сетевого входа)
...
## <a name="nt-eventlog-file"></a>NT Eventlog File (Файл журнала событий NT)
...
## <a name="office-addin"></a>Office Addin (Надстройка Office)
...
## <a name="office-client-metric"></a>Office Client Metric (Метрика клиента Office)
...
## <a name="office-device-summary"></a>Office Device Summary (Сводка по устройствам Office)
...
## <a name="office-document-metric"></a>Office Document Metric (Метрика документа Office)
...
## <a name="office-document-solution"></a>Office Document Solution (Решение для документов Office)
...
## <a name="office-macro-error"></a>Office Macro Error (Ошибка макроса Office)
...
## <a name="office-product-info"></a>Office Product Info (Сведения о продукте Office)
...
## <a name="office-vba-rule-violation"></a>Office Vba Rule Violation (Нарушение правила VBA)
...
## <a name="operating-system-ex"></a>Operating System Ex (Операционная система расширенная)
...
## <a name="operating-system-recovery-configuration"></a>Operating System Recovery Configuration (Конфигурация восстановления операционной системы)
...
## <a name="optional-feature"></a>Optional Feature (Дополнительная функция)
...
## <a name="page-file-setting"></a>Page File Setting (Параметр файла подкачки)
...
## <a name="parallel-port"></a>Parallel Port (Параллельный порт)
...
## <a name="pcmcia-controller"></a>PCMCIA Controller (PCMCIA-контроллер)
...
## <a name="physical-memory"></a>Физическая память
...
## <a name="pnp-device-driver"></a>PNP DEVICE DRIVER (Драйвер устройства PNP)
...
## <a name="pointing-device"></a>Pointing Device (Указывающее устройство)
...
## <a name="portable-battery"></a>Переносная батарея
...
## <a name="power-capabilities"></a>Power Capabilities (Возможности электропитания)

Пространство имен: root\CCM\powermanagementagent
...
## <a name="power-configurations"></a>Power Configurations (Схемы управления питанием)
...
## <a name="power-management-insomnia-reasons"></a>Power Management Insomnia Reasons (Управление питанием — причины невозможности перехода в спящий режим)
...
## <a name="power-management-daily"></a>Power Management Daily (Ежедневные данные управления питанием)
...
## <a name="power-client-opt-out-settings"></a>Power Client Opt Out Settings (Параметры отказа для клиента питания)

Пространство имен: root\ccm\ClientSDK
...
## <a name="power-management-monthly"></a>Power Management Monthly (Ежемесячные данные управления питанием)
...
## <a name="power-settings"></a>Power Settings (Параметры управления питанием)
...
## <a name="print-jobs"></a>Print Jobs (Задания печати)
...
## <a name="printer-configuration"></a>Printer Configuration (Конфигурация принтера)
...
## <a name="printer-device"></a>Printer Device (Печатающее устройство)
...
## <a name="protected-volume-information"></a>Protected Volume Information (Сведения о защищенном томе)
...
## <a name="quick-fix-engineering"></a>Quick Fix Engineering (Исправление QFE)
...
## <a name="ccm-recently-used-applications"></a>CCM Recently Used Applications (Последние использовавшиеся приложения CCM)
...
## <a name="scsi-controller"></a>SCSI Controller (Контроллер SCSI)
...
## <a name="serial-port-configuration"></a>Serial Port Configuration (Конфигурация последовательного порта)
...
## <a name="serial-ports"></a>Serial Ports (Последовательные порты)
...
## <a name="server-feature"></a>Серверный компонент
...
## <a name="sw-licensing-product"></a>SW Licensing Product (Продукт лицензирования ПО)
...
## <a name="sw-licensing-service"></a>SW Licensing Service (Служба лицензирования ПО)
...
## <a name="software-shortcut"></a>Software Shortcut (Ярлык программы)
...
## <a name="sound-devices"></a>Sound Devices (Звуковые устройства)
...
## <a name="system-account"></a>System Account (Системная учетная запись)
...
## <a name="system-boot-data"></a>System Boot Data (Данные о загрузке системы)
...
## <a name="system-boot-summary"></a>System Boot Summary (Сводка по загрузке системы)
...
## <a name="system-console-usage"></a>System Console Usage (Использование системной консоли)
...
## <a name="system-console-user"></a>System Console User (Пользователь системной консоли)
...
## <a name="system-devices"></a>System Devices (Системные устройства)
...
## <a name="system-drivers"></a>System Drivers (Системные драйверы)
...
## <a name="system-enclosure"></a>System Enclosure (Системный корпус)
...
## <a name="tape-drive"></a>Tape Drive (Ленточный накопитель)
...
Пространство имен: root\CIMv2\Security\MicrosoftTpm
...
## <a name="tpm-status"></a>TPM Status (Состояние доверенного платформенного модуля)
...
## <a name="ts-issued-license"></a>TS Issued License (Лицензия, выпущенная TS)
...
## <a name="ts-license-key-pack"></a>TS License Key Pack (Пакет лицензионных ключей TS)
...
## <a name="uninterruptible-power-supply"></a>Uninterruptible Power Supply (Источник бесперебойного питания)
...
## <a name="usb-controller"></a>USB-контроллер
...
## <a name="usb-device"></a>USB-устройство
...
## <a name="usm-user-profile"></a>USM User Profile (Профиль пользователя USM)
...
## <a name="video-controller"></a>Видеоконтроллер
...
## <a name="virtual-application-packages"></a>Virtual Application Packages (Пакеты виртуального приложения)

Пространство имен: root\Microsoft\appvirt\client
...
## <a name="virtual-machine-64"></a>Virtual Machine (64) (Виртуальная машина (64))
...
## <a name="virtual-machine-details"></a>Virtual Machine Details (Сведения о виртуальной машине)

Пространство имен: root\vm\VirtualServer
...
## <a name="windows-update-agent-version"></a>Windows Update Agent Version (Версия агента обновления Windows)
...
## <a name="write-filter-state"></a>Write Filter State (Состояние фильтра записи)
