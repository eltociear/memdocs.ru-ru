...
> [!IMPORTANT]  
> Клиент всегда разрешает установку программного обеспечения из Центра программного обеспечения, независимо от настроек подключения к Интернету. Если пользователь запрашивает установку программного обеспечения, когда устройство находится в сети с лимитным подключением к Интернету, этот запрос выполняется.<!-- MEMDocs#285 -->
