...
Политики защиты приложений могут применяться к приложениям на устройствах, которыми управляет или не управляет Intune. Подробное описание использования политик защиты приложений Intune, а также описание поддерживаемых этими политиками сценариев см. в разделе [Обзор политик защиты приложений](app-protection-policy.md).
...
Если вы ищете список приложений с интегрированным пакетом SDK для Intune, см. статью [Защищенные приложения Microsoft Intune](apps-supported-intune-apps.md).
