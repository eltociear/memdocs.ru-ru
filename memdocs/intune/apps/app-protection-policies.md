...
Для iOS/iPadOS требуются дополнительные параметры конфигурации политики защиты приложений (APP) для приложений на устройствах, зарегистрированных в Intune:
