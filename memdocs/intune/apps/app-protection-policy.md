...
## <a name="app-protection-policy-data-protection-framework"></a>Политики защиты приложений на платформе защиты данных
...
- У пользователя должна быть учетная запись Azure Active Directory (Azure AD). Дополнительные сведения о создании пользователей Intune в Azure Active Directory см. в статье [Добавление пользователей и предоставление административного разрешения для Intune](../fundamentals/users-add.md).
...
- Пользователь должен войти в приложение, используя свою учетную запись Azure AD.
