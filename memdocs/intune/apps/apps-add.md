...
| Приложения из других служб Майкрософт  | Intune создает ярлык приложения в приложении "Корпоративный портал". Дополнительные сведения см. в разделе [Параметры настройки источников приложений](../apps/company-portal-app.md#app-source-setting-options). | Приложения обновляются автоматически. |
...
| Приложения Office 365 для Windows 10  | Приложение магазина (Office 365) | В разделе **Приложения Microsoft 365** выберите **Windows 10** в качестве **типа приложения**, а затем выберите приложение Office 365, которое требуется установить.  |
| Приложения Office 365 для macOS | Приложение магазина (Office 365) | В разделе **Приложения Microsoft 365** выберите **macOS** в качестве **типа приложения**, а затем выберите пакет приложений Office 365. |
...
- **Приложения из других служб Майкрософт** Приложения, источником которых являются Azure AD или Office Online. **Корпоративные приложения Azure AD** регистрируются и назначаются на [портале Azure](https://portal.azure.com). **Приложения Office Online** назначаются с помощью элементов управления лицензированием, доступных в [центре администрирования M365](https://admin.microsoft.com). Вы можете скрывать или отображать корпоративные приложения Azure AD и приложения Office Online для каждого пользователя в Корпоративном портале. Чтобы найти этот параметр конфигурации, в [центре администрирования Microsoft Endpoint Manager](https://go.microsoft.com/fwlink/?linkid=2109431) выберите **Администрирование клиентов** > **Настройка**. Выберите **Скрыть** или **Показать** для **корпоративных приложений Azure AD** или **приложений Office Online** в Корпоративном портале для каждого пользователя. Каждый конечный пользователь увидит весь каталог приложений из выбранной службы Майкрософт. По умолчанию для каждого дополнительного источника приложения будет установлено значение **Скрыть**. Дополнительные сведения см. в разделе [Параметры настройки источников приложений](../apps/company-portal-app.md#app-source-setting-options). 
