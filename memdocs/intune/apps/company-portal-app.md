...
Настроив пользовательский интерфейс, вы поможете организовать удобную и привычную рабочую среду для своих пользователей. Для этого перейдите в [центр администрирования Microsoft Endpoint Manager](https://go.microsoft.com/fwlink/?linkid=2109431), выберите элементы **Администрирование клиентов** > **Настройка**, а затем настройте необходимые параметры. Эти параметры будут применяться к приложениям Корпоративного портала, веб-сайту "Корпоративный портал" и приложениям Intune для Android.
