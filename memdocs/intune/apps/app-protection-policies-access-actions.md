...
Выбрав соответствующие параметры, вы можете явным образом выбрать очистку корпоративных данных с устройства пользователя в случае несоблюдения этих требований. Для некоторых параметров можно настроить несколько действий, например, блокировать доступ и очистить данные, в зависимости от значения параметра.
...
- **Очистить данные** — очистить корпоративные данные с устройства пользователя.
