...
5. Щелкните **Выбрать нужное приложение**. Затем на панели **Целевые приложения** выберите **Managed Browser** или **Microsoft Edge** для iOS/iPadOS, Android или обеих платформ.
...
Microsoft Edge можно использовать как браузер, защищенный политикой. Чтобы пользователи направлялись в соответствующий браузер, назначьте для всех управляемых Intune приложений (например, Outlook, OneDrive и SharePoint) следующие параметры конфигурации:
