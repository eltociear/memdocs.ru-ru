...
| Соответствует     | Количество устройств, к которым успешно применены одна или несколько политик соответствия требованиям, назначенных администратором.                                                                        | 4083     |
...
| Соответствует         | Количество устройств, к которым успешно применены одна или несколько политик соответствия требованиям, назначенных администратором.                                                                        | 45       |
...
| Сбой    | Число уникальных устройств в состоянии неудачного выполнения.                                                     | 2        |
...
| Сбой  | Число уникальных пользователей в состоянии неудачного выполнения.  | 2  |
...
| Сбой    | Количество уникальных устройств в состоянии сбоя.                                                     | 2                     |
...
|    isDeleted    |    Указывается значение true или false для обозначения удаления.     |    Ложь    |
