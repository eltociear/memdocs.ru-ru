...
6. В разделе **Делегированное разрешение** установите флажок **DeviceManagementManagedApps.ReadWrite: чтение и запись данных управления приложениями пользователя***.
