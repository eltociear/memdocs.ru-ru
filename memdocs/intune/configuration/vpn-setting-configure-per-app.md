...
Профиль VPN содержит сертификат SCEP или PKCS с учетными данными клиента, сведения о подключении к VPN и флаг VPN на уровне приложения для активации соответствующей функции в приложении iOS/iPadOS.
...
4. Выберите **Базовая VPN**. Список параметров VPN для iOS/iPadOS и их описание см. [здесь](vpn-settings-ios.md). При использовании VPN на уровне приложений необходимо задать указанные ниже свойства.
