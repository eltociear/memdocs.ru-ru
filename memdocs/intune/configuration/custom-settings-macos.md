...
[Создание настраиваемого профиля macOS](custom-settings-configure.md).
...
- **Имя профиля конфигурации**. Введите имя политики. Это имя отображается на устройстве и в состоянии Intune.
- **Файл профиля конфигурации.** Перейдите к файлу `.xml` или `.mobileconfig`, созданному с помощью Apple Configurator или Apple Profile Manager. Максимальный размер файла составляет 1 000 000 байт (всего 1 МБ). Будет показан импортируемый файл. После добавления файла его можно также **удалить**.
