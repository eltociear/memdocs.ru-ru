...
3. Введите следующие параметры:
    ...
    - **Имя** — Введите описательное имя для нового профиля. Имя **должно** соответствовать значению атрибута name в XML-файле профиля Wi-Fi. В противном случае произойдет сбой.
    - **Описание**. введите описание с общими сведениями о параметре и другой важной информацией.
    - **Платформа**. Выберите **Windows 8.1 и более поздние версии**.
    - **Тип профиля**. Выберите **Импорт Wi-Fi**.
