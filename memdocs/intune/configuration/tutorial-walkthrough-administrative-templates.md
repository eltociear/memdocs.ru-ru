...
5. Выберите **Далее**.
6. В разделе **Параметры конфигурации** в раскрывающемся списке выберите**Все продукты**. Отображаются все параметры. В этих параметрах обратите внимание на следующие свойства:
...
1. В шаблоне выберите пункты **Назначения** > **Выберите группы для включения**.
...
3. Выберите **Далее**, чтобы перейти на вкладку **Проверка + создание**. Щелкните **Создать**, чтобы сохранить изменения.
...
5. Выберите **Далее**.
6. В разделе **Параметры конфигурации** выберите в раскрывающемся списке пункт **Офис**. **Включите** следующие параметры. Обязательно нажмите кнопку **OK**, чтобы сохранить изменения.
