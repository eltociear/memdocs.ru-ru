...
При интеграции Jamf Pro с Intune можно использовать политики условного доступа для обеспечения соответствия на устройствах Mac в рамках требований организации. Эта статья поможет вам при выполнении следующих задач:  
...
Intune поддерживает два метода интеграции Jamf Pro, которые настраиваются отдельно от процедур, описанных в этой статье.

- Рекомендуемое требование. [Использование соединителя Jamf Cloud для интеграции Jamf Pro с Intune](conditional-access-jamf-cloud-connector.md)
- [Настройка интеграции Jamf Pro с Intune вручную](conditional-access-integrate-jamf.md)
