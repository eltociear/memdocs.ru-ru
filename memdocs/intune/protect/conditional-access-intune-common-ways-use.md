...
- **Локальные устройства, присоединенные к домену AD.** Этот вариант обычно используется организациями, которые в достаточной мере удовлетворены текущим управлением компьютерами при помощи групповых политик AD или Configuration Manager.
