...
## <a name="user-rights"></a>Права пользователей
...
- **Доступ к диспетчеру учетных данных от имени доверенного вызывающего**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя используется диспетчером учетных данных во время операций резервного копирования и восстановления. Сохраненные учетные данные пользователей могут быть скомпрометированы, если эта привилегия передана другим сущностям.
  - **Не настроено**.
  - **Разрешить**
...
- **Разрешить локальный вход**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, какие пользователи могут входить на компьютер.
  - **Не настроено**.
  - **Разрешить**

- **Разрешить доступ по сети**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, каким пользователям и группам разрешено подключаться к компьютеру по сети.
  - **Не настроено**.
  - **Разрешить**
...
- **Архивация файлов и каталогов**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, какие пользователи могут обходить разрешения на файлы, каталоги, реестры и другие постоянные объекты при резервном копировании файлов и каталогов.
  - **Не настроено**.
  - **Разрешить**
...
- **Изменение системного времени**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, каким пользователям и группам разрешено изменять время и дату на внутренних часах компьютера.
  - **Не настроено**.
  - **Разрешить**
...
- **Создать файл подкачки**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, какие пользователи и группы могут вызывать внутренний API для создания и изменения размера файла подкачки.
  - **Не настроено**.
  - **Разрешить**
...
- **Создание постоянных общих объектов**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, какие учетные записи могут использоваться процессами для создания объекта каталога с помощью диспетчера объектов.
  - **Не настроено**.
  - **Разрешить**
...
- **Создание символических ссылок**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, может ли пользователь создать символическую ссылку с компьютера, на который он вошел.
  - **Не настроено**.
  - **Разрешить**
...
- **Создать токены**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, какие пользователи или группы могут использоваться процессами для создания токена, который затем может использоваться для получения доступа к любым локальным ресурсам, когда процесс использует внутренний API для создания токена доступа.
  - **Не настроено**.
  - **Разрешить**
...
- **Отладка программ**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, какие пользователи могут подключать отладчик к любому процессу или ядру.
  - **Не настроено**.
  - **Разрешить**

- **Запретить доступ по сети**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, каким пользователям запрещен доступ к компьютеру по сети.
  - **Не настроено**.
  - **Разрешить**
...
- **Отказ во входе в качестве службы**  
  **По умолчанию**: Не настроено  
  ...
  Этот параметр безопасности определяет, каким учетным записям служб запрещено регистрировать процесс в качестве службы.
  - **Не настроено**.
  - **Разрешить**

- **Запрет входа в систему через службу удаленных рабочих столов**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, каким пользователям и группам запрещено входить в систему в качестве клиента служб удаленных рабочих столов.
  - **Не настроено**.
  - **Разрешить**
...
- **Разрешить делегирование**  
 ...
 Это право пользователя определяет, какие пользователи могут устанавливать параметр "Доверять для делегирования" для объекта пользователя или компьютера.
  - **Не настроено**.
  - **Разрешить**
...
- **Создание аудитов безопасности**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, какие учетные записи могут использоваться процессом для добавления записей в журнал безопасности. Журнал безопасности используется для отслеживания неавторизованного доступа к системе.
  - **Не настроено**.
  - **Разрешить**
...
- **Олицетворять клиента**  
  **По умолчанию**: Не настроено  
  ...
  Назначение этому пользователю права пользователя позволяет программам, выполняемым от имени этого пользователя, олицетворять клиента. Обязательное использование этого права пользователя для этого типа олицетворения не позволяет неавторизованному пользователю убедить клиента подключиться к службе, которая была создана неавторизованным пользователем, и олицетворять этого клиента, что может повысить уровень разрешений неавторизованного пользователя до уровня администратора или системы.
  - **Не настроено**.
  - **Разрешить**
...
- **Увеличение приоритета выполнения**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, какие учетные записи могут использовать процесс с доступом на запись свойств для другого процесса, чтобы повысить приоритет выполнения, назначенный другому процессу.
  - **Не настроено**.
  - **Разрешить**
...
- **Загрузка и выгрузка драйверов устройств**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, какие пользователи могут динамически загружать и выгружать драйверы устройств или другой код в режиме ядра.
  - **Не настроено**.
  - **Разрешить**
...
- **Блокировка страниц в памяти**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, какие учетные записи могут использовать процесс для хранения данных в физической памяти, что предотвращает страничную запись данных операционной системой в область виртуальной памяти на диск.
  - **Не настроено**.
  - **Разрешить**
...
- **Управление журналом аудита и безопасности**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, какие пользователи могут задавать параметры аудита доступа к объектам для отдельных ресурсов, таких как файлы, объекты Active Directory и разделы реестра.
  - **Не настроено**.
  - **Разрешить**
...
- **Выполнение задач по обслуживанию томов**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, какие пользователи и группы могут запускать задачи обслуживания для тома, например удаленную дефрагментацию тома.
  - **Не настроено**.
  - **Разрешить**

- **Изменение значений среды встроенного ПО**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, кто может изменять значения среды встроенного ПО.
  - **Не настроено**.
  - **Разрешить**
...
- **Изменение метки объекта**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, какие учетные записи пользователей могут изменять метки целостности объектов, таких как файлы, разделы реестра или процессы, принадлежащие другим пользователям.
  - **Не настроено**.
  - **Разрешить**
...
- **Профилирование одного процесса**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет пользователей, которые могут использовать средства мониторинга производительности для отслеживания производительности системных процессов.
  - **Не настроено**.
  - **Разрешить**
...
- **Удаленное завершение работы**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, каким пользователям разрешено удаленное завершение работы компьютера по сети. Неправильное использование этого права пользователя может привести к отказу в обслуживании.
  - **Не настроено**.
  - **Разрешить**
...
- **Восстановление файлов и каталогов**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, какие пользователи могут обходить разрешения на файлы, каталоги, реестр и другие постоянные объекты при восстановлении резервных копий файлов и каталогов, а также какие пользователи могут устанавливать любой допустимый субъект безопасности в качестве владельца объекта.
  - **Не настроено**.
  - **Разрешить**
  
- **Смена владельцев файлов или объектов**  
  **По умолчанию**: Не настроено  
  ...
  Это право пользователя определяет, какие пользователи могут становиться владельцами любого защищаемого объекта в системе, включая объекты Active Directory, файлы и папки, принтеры, разделы реестра, процессы и потоки.
  - **Не настроено**.
  - **Разрешить**
