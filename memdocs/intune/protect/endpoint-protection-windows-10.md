...
- **Отключать устройство от станции без входа в систему**  
  **По умолчанию**: Не настроено  
  ...
  - **Блокировать** — пользователю нужно войти на устройство и получить разрешение на его отключение.
  - **Не настроено** — пользователи могут нажать кнопку физического извлечения подключенного переносного устройства для его безопасного отключения.
...
- **Require CTRL+ALT+DEL to log on** (Требовать нажатия CTRL+ALT+DEL перед входом в систему)  
  **По умолчанию**: Не настроено  
  ...
  - **Включить** — пользователи должны нажать клавиши CTRL+ALT+DEL перед входом в Windows.
  - **Не настроено** — для входа пользователям необязательно нажимать клавиши CTRL+ALT+DEL.
