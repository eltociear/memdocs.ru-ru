...
- **Включить Application Guard для Microsoft Edge (параметры)**  
  ...
  - **Включено для Edge** (*по умолчанию*). Application Guard открывает недоверенные сайты в виртуализированном контейнере браузера Hyper-V.
  - **Не настроено**. Любой веб-сайт (доверенный и недоверенный) открывается на устройстве, а не в виртуализированном контейнере.  
  
  Если задано значение *Включить для Edge*, можно настроить *Блокировать внешнее содержимое с утвержденных сайтов, не являющихся корпоративными* и *Поведение буфера обмена*.
