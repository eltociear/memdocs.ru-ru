...
- **Блокировать Windows: интересное**.  
  ...
  **По умолчанию**: Да
  ...
  Если параметр *Блокировать Windows: интересное* имеет значение *Не задан*, значит эта функция не заблокирована на устройствах и вы сможете настроить приведенные ниже параметры для блокировки отдельных ее элементов.
...
- **Не запускать антивредоносную программу для элементов ActiveX в зоне надежных сайтов Internet Explorer**.  
  Этот параметр политики определяет, выполняет ли Internet Explorer антивредоносные программы для элементов ActiveX, чтобы проверять, являются ли они безопасными для загрузки страниц. Если включить этот параметр политики, Internet Explorer не будет проверять антивредоносные программы, чтобы узнать, безопасно ли будет создать экземпляр элемента управления ActiveX. Если отключить этот параметр политики, Internet Explorer всегда будет проверять антивредоносные программы, чтобы узнать, безопасно ли будет создать экземпляр элемента управления ActiveX. Если не настроить этот параметр политики, Internet Explorer всегда будет проверять антивредоносные программы, чтобы узнать, безопасно ли будет создать экземпляр элемента управления ActiveX. Пользователи могут включать или выключать это поведение с помощью параметров безопасности Internet Explorer.  
...
- **Требовать от клиентов всегда использовать цифровую подпись при взаимодействии**:  
...
- **Уровень проверки подлинности**.  
  ...
  - *Отправлять LM и NTLM — NTLMv2 при согласовании* — клиенты используют проверку подлинности LM и NTLM, а также сеансовую безопасность NTLMv2, если сервер поддерживает ее. Контроллеры домена принимают проверку подлинности LM, NTLM и NTLMv2.
  ...
  - *Отправлять только ответ NTLMv2. Запрещать LM* — клиенты используют только проверку подлинности NTLMv2, а также сеансовую безопасность NTLMv2, если сервер ее поддерживает. Контроллеры домена не принимают LM (принимают только проверку подлинности NTLM и NTLMv2).

  - *Отправлять только ответ NTLMv2. Запрещать LM и NTLM* — клиенты используют только проверку подлинности NTLMv2, а также сеансовую безопасность NTLMv2, если сервер ее поддерживает. Контроллеры домена не принимают LM и NTLM (принимают только проверку подлинности NTLMv2).
...
- **Разрешить UIAccess-приложения только для безопасных расположений**.  
...
- **Enter how often (0-24 hours) to check for security intelligence updates** (Введите частоту (от 0 до 24 часов) проверки наличия обновлений для механизма обнаружения угроз)  
  ...
  Укажите частоту проверки наличия новых сигнатур. Значение 1 — один час, 2 — два часа и т. д.
...
- **Включить защиту, предоставляемую облаком**.  
  CSP: [Defender/AllowCloudProtection](https://go.microsoft.com/fwlink/?linkid=2113937)
  
  Если установлено "Да", Защитник отправляет в Майкрософт сведения о любых найденных проблемах. Если задано значение "Не настроено", клиент вернется к значению по умолчанию, которое включает функцию, но позволяет пользователю отключить ее.
...
- **Включить защиту в реальном времени**  
  ...
  Если для этого параметра задано значение "Да", то будет применяться мониторинг в реальном времени и пользователь не сможет его отключить. Если задано значение "Не настроено", параметр возвращается к значению клиента по умолчанию ("Включено"), но пользователь может его изменить. Чтобы отключить мониторинг в режиме реального времени, используйте настраиваемый универсальный код ресурса (URI).
...
- **Проверять архивные файлы**.  
  ...
  Если задано значение "Да", будет проводиться проверка архивных файлов, таких как ZIP или CAB. Если задано значение "Не настроено", используется значение по умолчанию для клиента, согласно которому проверка архивных файлов включена, но пользователь может ее отключить.
...
- **Включить наблюдение за поведением**.  
  ...
  Если для этого параметра задано значение "Да", то будет применяться наблюдение за поведением и пользователь не сможет его отключить. Если задано значение "Не настроено", параметр возвращается к значению клиента по умолчанию ("Включено"), но пользователь может его изменить. Чтобы отключить мониторинг в режиме реального времени, используйте настраиваемый универсальный код ресурса (URI).
...
- **Сканировать входящие сообщения электронной почты**.  
  ...
  Если задано значение "Да", проверяются почтовый ящик и файлы почты, такие как PST, DBX, МНКС, MIME и BINHEX. Если задано значение "Не настроено". то параметр возвращается к значению клиента по умолчанию и файлы электронной почты не проверяются.
...
- **Сканировать съемные диски при полной проверке**.  
  ...
  Если задано значение "Да", во время полной проверки проверяются съемные диски (например, USB-устройства флэш-памяти). Если задано значение "Не настроено", используется значение по умолчанию для клиента, при котором съемные диски проверяются, но пользователь может отключить эту проверку.
  **По умолчанию**: Да  
...
- **Блокировать вставку кода приложениями Office в другие процессы**.  
  ...
  Если задано значение "Да", приложения Office не могут внедрять код в другие процессы. Если задано значение "Только аудит", вместо блокировки создаются события Windows. Если задано значение "Не настроено", используется значение Windows по умолчанию, то есть "Отключено". Это правило ASR управляется с помощью следующего идентификатора GUID: 75668C1F-73B5-4CF0-BB93-3ECF5CB7CC84
...
- **Блокировать создание исполняемого содержимого приложений Office**  
  ...
  Если задано значение "Да", приложения Office не смогут создавать исполняемое содержимое. Если задано значение "Только аудит", вместо блокировки создаются события Windows. Если задано значение "Не настроено", используется значение Windows по умолчанию, то есть "Отключено". Это правило ASR управляется с помощью следующего идентификатора GUID: 3B576869-A4EC-4529-8536-B80A7769E899
...
- **Блокировать создание дочерних процессов всех приложений Office**  
  ...
  Если задано значение "Режим аудита", вызываются события Windows вместо блокировки. Если задано значение "Не настроено", используется значение Windows по умолчанию, то есть "Отключено". Это правило ASR управляется с помощью следующего идентификатора GUID: D4F940AB-401B-4EFC-AADC-AD5F3C50688A
...
- **Блокировать вызовы API Win32 из макросов Office**.  
  ...
  Если задано значение "Да", макросы Office будут заблокированы с помощью вызовов API Win32. Если задано значение "Только аудит", вместо блокировки создаются события Windows. Если задано значение "Не настроено", используется значение Windows по умолчанию, то есть "Отключено". Это правило ASR управляется с помощью следующего идентификатора GUID: 92E97FA1-2EDF-4476-BDD6-9DD0B4DDDC7B
...
- **Блокировать выполнение потенциально маскируемых сценариев (js/vbs/ps)** .  
  ...
  Если задано значение "Да", Defender блокирует выполнение замаскированных сценариев. Если задано значение "Только аудит", вместо блокировки создаются события Windows. Если задано значение "Не настроено", используется значение Windows по умолчанию, то есть "Отключено". Это правило ASR управляется с помощью следующего идентификатора GUID: 5BEB7EFE-FD9A-4556-801D-275E5FFC04CC
  
  **По умолчанию**: Блокировать

- **Email content execution type** (Тип выполнения содержимого электронной почты).    
  [Блокировать исполняемое содержимое, загруженное из клиентов электронной почты и веб-почты](https://go.microsoft.com/fwlink/?linkid=872980)

  Если задано значение "Да", исполняемое содержимое, загруженное из клиентов электронной почты и веб-почты, блокируется. Если задано значение "Только аудит", вместо блокировки создаются события Windows. Если задано значение "Не настроено", используется значение Windows по умолчанию, то есть "Отключено".
...
- **Prevent credential stealing type** (Тип предотвращения хищения учетных данных).  
  ...
  Если задано значение "Да", блокируются попытки украсть учетные данные с помощью lsass.exe. Если задано значение "Только аудит", вместо блокировки создаются события Windows. Если задано значение "Не настроено", используется значение Windows по умолчанию, то есть "Отключено". Это правило ASR управляется с помощью следующего идентификатора GUID: 9e6c4e1f-7d60-472f-ba1a-a39ef669e4b2
...
- **Блокировать ненадежные и неподписанные процессы, выполняемые с USB**.  
  ...
  Если задано значение "Да", ненадежные или неподписанные процессы, выполняемые с USB-накопителя, будут заблокированы. Если задано значение "Только аудит", вместо блокировки создаются события Windows. Если задано значение "Не настроено", используется значение Windows по умолчанию, то есть "Отключено". Это правило ASR управляется с помощью следующего идентификатора GUID: b2b3f03d-6a65-4f7b-a9c7-1c7ef74a9ba4
...
- **Защита сети**.  
  ...
  Если задано значение "Да", защита сети включена для всех пользователей в системе. Защита сети защищает сотрудников от фишинговых атак и вредоносного содержимого в Интернете. Сюда входят браузеры сторонних производителей. Если задать для этого параметра значение "Только аудит", пользователям не будет заблокирован доступ к опасным доменам, но будут возникать события Windows. Если задано значение "Не настроено", используется значение Windows по умолчанию, то есть "Отключено".
...
- **Блокировать запуск скачанного исполняемого содержимого JavaScript или VBScript**  
  ...
  Если задано значение "Да", Defender блокирует исполнение файлов JavaScript или VBScript, скачанных из Интернета. Если задано значение "Только аудит", вместо блокировки создаются события Windows. Если задано значение "Не настроено", используется значение Windows по умолчанию, то есть "Отключено". Это правило ASR управляется с помощью следующего идентификатора GUID: D3E037E1-3EB8-44C8-A917-57927947596D
...
- **Перенаправления сетевого протокола ICMP переопределяют маршруты, создаваемые OSPF**.  
...
- **Включить Windows SmartScreen**  
  ...
  Если задано значение "Да", использование SmartScreen будет обязательным для всех пользователей. Если задано значение "Не настроено", используется значение Windows по умолчанию, то есть SmartScreen включен, однако пользователи могут изменить этот параметр. Чтобы отключить SmartScreen, используйте настраиваемый URI.
...
- **Запретить пользователям пропускать предупреждения SmartScreen**  
  ...
  Если задано значение "Да", SmartScreen не будет предоставлять пользователю возможность проигнорировать предупреждение и запустить приложение. Пользователь увидит предупреждение, но сможет обойти его. Если задано значение "Не настроено", используется значение Windows по умолчанию, то есть пользователь может переопределить этот параметр. Для этого параметра требуется включить параметр "Принудительное применение SmartScreen для приложений и файлов".
...
- **Блокирование Windows Hello для бизнеса**  
  Windows Hello для бизнеса — это альтернативный метод входа в Windows путем замены паролей, смарт-карт и виртуальных смарт-карт. Если вы отключили или не настроили этот параметр политики, устройство подготавливает Windows Hello для бизнеса. Если вы включили этот параметр политики, устройство не подготавливает Windows Hello для бизнеса для пользователей.
  ...
  **По умолчанию**: Включено
  ...
  - **Включить и использовать расширенную защиту от спуфинга, когда это возможно**  
    [Защита от спуфинга](https://go.microsoft.com/fwlink/?linkid=2067192)

    Если включить этот параметр, устройства будут использовать расширенную защиту от спуфинга, когда это возможно. Если этот параметр не настроен, будет учитываться конфигурация клиента для защиты от спуфинга.

    **По умолчанию**: Не настроено

  - **Lowercase letters in PIN** (Строчные буквы в ПИН-коде).  
    Если установлено "Требуется", ПИН-код пользователя должен содержать по крайней мере одну строчную букву.

    **По умолчанию**: Запрещено

  - **Special characters in PIN** (Специальные символы в ПИН-коде).  
    Если установлено "Требуется", ПИН-код пользователя должен содержать по крайней мере один специальный символ.

    **По умолчанию**: Запрещено
 

  - **Uppercase letters in PIN** (Прописные буквы в ПИН-коде).  
...
- **Регистрация блоков сценариев в PowerShell**.  
