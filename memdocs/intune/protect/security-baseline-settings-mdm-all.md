...
- **Configure Windows Hello for Business** (Настроить Windows Hello для бизнеса)
  ...
  Вы не можете отключить Windows Hello для бизнеса через этот базовый показатель. Вы можете отключить Windows Hello для бизнеса при настройке [регистрации Windows](windows-hello.md) или в рамках профиля конфигурации устройства для [защиты идентификации](identity-protection-configure.md).  
