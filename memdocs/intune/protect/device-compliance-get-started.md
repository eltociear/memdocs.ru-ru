...
Для обеспечения соответствия требованиям Intune использует [условный доступ](../protect/conditional-access.md). Условный доступ — это технология Azure Active Directory (Azure AD).

Когда устройство регистрируется в Intune, в Azure AD начинается процесс регистрации и обновляется информация об устройстве. Одной из основных характеристик устройства является его состояние соответствия. Оно используется политиками условного доступа для блокировки или разрешения доступа к электронной почте и другим ресурсам организации.
...
Сведения об условном доступе в документации по Azure AD
  - [Что такое условный доступ?](https://docs.microsoft.com/azure/active-directory/conditional-access/overview)
  - [Что такое удостоверение устройства?](https://docs.microsoft.com/azure/active-directory/device-management-introduction)
...
- **Отметка устройств без назначенной политики соответствия**. Это действие по умолчанию при несоответствии. Это свойство имеет два значения:
