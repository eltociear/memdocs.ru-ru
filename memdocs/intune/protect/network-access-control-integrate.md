...
### <a name="to-enable-nac-for-cisco-anyconnect-for-ios"></a>Чтобы включить NAC для Cisco AnyConnect для iOS, выполните следующие действия:
...
### <a name="to-enable-nac-for-citrix-sso"></a>Чтобы включить NAC для Citrix SSO, сделайте следующее:
...
### <a name="to-enable-nac-for-f5-access"></a>Чтобы включить NAC для F5 Access:
