...
Список доступных базовых показателей см. в [Центре администрирования Microsoft Endpoint Manager](https://go.microsoft.com/fwlink/?linkid=2109431) в разделе **Безопасность конечных точек** > **Базовые показатели безопасности**. Список содержит имя шаблона базовых показателей, сведения о количестве профилей для определенного типа базовых показателей, количество доступных экземпляров (версий) типа базовых показателей и дату *последней публикации*, которая показывает, когда этот шаблон стал доступен.

Для просмотра дополнительных сведений об используемых версиях базовых показателей выберите плитку базовых показателей, чтобы открыть панель *Обзор*, а затем выберите **Версии**. В Intune отобразятся сведения об используемых в ваших профилях версиях базовых показателей, включая последнюю и текущую версию.  Выберите версию, чтобы получить подробные сведения о профилях, в которых используется эта версия.
...
Чтобы понять, что изменилось между версиями, установите флажки для двух разных версий, а затем выберите **Сравнить базовые показатели**, чтобы скачать CSV-файл, в котором подробно описаны эти различия. 
