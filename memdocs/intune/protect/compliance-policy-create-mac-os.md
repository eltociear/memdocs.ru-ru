...
**Разрешить приложения, скачанные из этих расположений**: позволяет устанавливать поддерживаемые приложения на устройствах из разных мест. Варианты расположений:
