...
## <a name="access-for-managed-devices"></a>Доступ для управляемых устройств  
...
|Домены    |IP-адрес      |
|-----------|----------------|
|login.microsoftonline.com <br> *.officeconfig.msocdn.com <br> config.office.com <br> graph.windows.net| Дополнительные сведения о [URL-адресах и диапазонах IP-адресов Office 365](https://support.office.com/article/Office-365-URLs-and-IP-address-ranges-8548a211-3fe7-47cb-abb1-355ea5aa88a2) |
...
Дополнительные сведения см. в статьях [Порты TCP и UDP, используемые программными продуктами Apple](https://support.apple.com/HT202944), [Фоновые процессы iTunes и подключения к серверам macOS, iOS/iPadOS и iTunes](https://support.apple.com/HT201999) и [Если клиенты macOS и iOS/iPadOS не получают push-уведомления от Apple](https://support.apple.com/HT203609) на сайте Apple.  