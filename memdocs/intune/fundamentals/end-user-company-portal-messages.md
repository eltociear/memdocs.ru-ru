...
Если вы не добавили приложение корпоративного портала в список **Разрешенные приложения** или **Исключенные приложения** и пользователь пытается выполнить вход, попытка завершится ошибкой. Отображается следующее сообщение:
