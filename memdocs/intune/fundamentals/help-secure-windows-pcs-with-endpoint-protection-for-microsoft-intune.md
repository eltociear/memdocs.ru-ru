...
|**Выполнить быструю проверку, если пропущены две быстрые проверки подряд**|Настройка автоматического выполнения быстрой проверки Endpoint Protection на компьютерах, если пропущены две последовательные быстрые проверки.<br /><br />Рекомендуемое значение: **Да**|
|**Запланировать полную проверку**|Настройка полной проверки всех файлов и ресурсов на локальных жестких дисках компьютера. Такая проверка может занять некоторое время и повлиять на производительность компьютера (необходимое время зависит от количества проверяемых файлов и ресурсов).<br /><br />Рекомендуемое значение: **Нет**|
