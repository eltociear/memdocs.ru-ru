...
Ниже приведено несколько примеров применения в организации различных наборов требований для каждого сценария основных и второстепенных вариантов использования, организационных групп и платформ мобильных устройств. Приведенную ниже таблицу можно использовать и для указания требований к вариантам использования в организации.
