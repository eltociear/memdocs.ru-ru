...
#### <a name="company-portal-for-ios-supports-landscape-mode--6048329-wnready---"></a>Корпоративный портал для iOS поддерживает альбомный режим<!--6048329 wnready -->   
...
#### <a name="script-support-for-macos-devices-public-preview---4280361-wnready---"></a>Поддержка сценариев для устройств macOS (общедоступная предварительная версия)<!-- 4280361 wnready -->
...
> [!NOTE] 
> В течение нескольких недель пользовательский интерфейс Intune получит обновление и сможет работать в полноэкранном режиме. В текущей версии процесс создания или изменении параметров может несколько отличаться.
