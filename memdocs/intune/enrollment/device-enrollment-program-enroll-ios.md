...
В iOS и iPadOS 11 прекращена поддержка незащищенных устройств ADE. В iOS и iPadOS 11 и более поздних версий устройства, настроенные с помощью ADE, должны всегда быть защищены. Флаг ADE *is_supervised* будет игнорироваться в будущем выпуске iOS и iPadOS.
