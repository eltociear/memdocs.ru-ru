...
3. В разделе **Создание профиля** в поле **Имя** введите *TestDEPProfile*, а в поле **Описание** — *Тестирование DEP для устройств iOS и iPadOS*. Пользователям эти сведения не отображаются.
...
> [Подробная статья о регистрации устройств iOS и iPadOS в программе DEP](device-enrollment-program-enroll-ios.md)
