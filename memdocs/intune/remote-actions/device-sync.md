...
Действие **Синхронизация** приводит к немедленной проверке изменений в Intune для выбранного устройства. При возврате устройство сразу же получает все ожидающие действия или политики, которые были ему назначены. Эта функция позволяет сразу проверять назначенные политики и устранять возникшие с неполадки, не дожидаясь следующего запланированного возврата.
