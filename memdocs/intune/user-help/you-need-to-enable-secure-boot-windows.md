...
Если вы используете ПК, обратитесь в службу поддержки вашей компании или ознакомьтесь с разделом "Повторное включение безопасной загрузки" статьи [Отключение безопасной загрузки](https://msdn.microsoft.com/library/windows/hardware/dn898540(v=vs.85).aspx), чтобы попытаться включить безопасную загрузку самостоятельно.
