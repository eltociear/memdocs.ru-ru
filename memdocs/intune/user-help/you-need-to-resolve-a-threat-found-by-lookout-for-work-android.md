...
![Пример снимка экрана с предупреждением Lookout for Work о вирусах поверх интерфейса приложения. Показывает три кнопки: "Закрыть", "Дополнительные сведения "и" Удалить".](./media/lookout-virus-alert-android.png)  
